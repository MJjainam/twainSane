...
*/
    APP_INFO &operator[](TWID_T AppId)
    {
        if (AppId >= m_count)
        {
            ...
            if (pNewList == NULL)
            {
                writeToLog("apps.cpp: realloc of m_pList failed AppId " + std::to_string(AppId));
...
*/
    bool Erase(TWID_T AppId)
    {
        ...
        {
            writeToLog("AppId = + " + std::to_string(AppId) +" is invalid" );
            return false;
        }
        if (AppId == (m_count - 1))
        {
            ...
            if (pNewList == NULL)
            {
                writeToLog("realloc of m_pList failed AppId = " +std::to_string(AppId) );
                return false;
            }
            m_pList = pNewList;
        }
...
CTwnDsmApps::~CTwnDsmApps()
{
    if (m_ptwndsmappsimpl)
    {
        ...
        {
            if (m_ptwndsmappsimpl->m_AppInfo[i].identity.Id && dsmState_Open != m_ptwndsmappsimpl->m_AppInfo[i].CurrentState)
            {
                              ...
                              TW_MEMREF _MemRef)
{
   ...
   // kLOG((kLOGINFO, "             TWAIN %u.%u", _pAppId->ProtocolMajor, _pAppId->ProtocolMinor));
    ...
    {
        if (!strncmp((char *)m_ptwndsmappsimpl->m_AppInfo[ii].identity.ProductName, (char *)_pAppId->ProductName, sizeof(TW_STR32)) && m_ptwndsmappsimpl->m_AppInfo[ii].hwnd == (HWND)(_MemRef ? *(HWND *)_MemRef : 0))
        {
...
TW_UINT16 CTwnDsmApps::RemoveApp(TW_IDENTITY *_pAppId)
{
    ...
    // Validate...
    if (((TWID_T)_pAppId->Id == 0) || ((TWID_T)_pAppId->Id > m_ptwndsmappsimpl->m_AppInfo.size()))
    {
                                          ...
                                          TW_UINT16 _ConditionCode)
{
    ...
    if ((0 == _pAppId) || (0 == (TWID_T)_pAppId->Id) || (0 == m_AppInfo[(TWID_T)_pAppId->Id].identity.Id))
    {
...
TWID_T CTwnDsmApps::AppGetNumDs(TW_IDENTITY *_pAppId)
{
    ...
    if (AppValidateId(_pAppId) && m_ptwndsmappsimpl->m_AppInfo[(TWID_T)_pAppId->Id].pDSList)
    {
                                        ...
                                        TWID_T _DsId)
{
    ...
    if (AppValidateId(_pAppId) && m_ptwndsmappsimpl->m_AppInfo[(TWID_T)_pAppId->Id].pDSList && (_DsId < MAX_NUM_DS))
    {
...
// versions...
    ...
    if (((twidentitylinux64safe.twidentity.SupportedGroups & (DG_CONTROL | DG_IMAGE)) == (DG_CONTROL | DG_IMAGE)) && (((twidentitylinux64safe.twidentity.ProtocolMajor >= 3) && (twidentitylinux64safe.twidentity.ProtocolMinor <= 9)) || ((twidentitylinux64safe.twidentity.ProtocolMajor == 2) && (twidentitylinux64safe.twidentity.ProtocolMinor >= 4) && (twidentitylinux64safe.twidentity.ProtocolMinor <= 9)) || ((twidentitylinux64safe.twidentity.ProtocolMajor == 1) && (twidentitylinux64safe.twidentity.ProtocolMinor == 5)) || ((twidentitylinux64safe.twidentity.ProtocolMajor == 1) && (twidentitylinux64safe.twidentity.ProtocolMinor == 6)) || ((twidentitylinux64safe.twidentity.ProtocolMajor == 1) && (twidentitylinux64safe.twidentity.ProtocolMinor == 7)) || ((twidentitylinux64safe.twidentity.ProtocolMajor == 1) && (twidentitylinux64safe.twidentity.ProtocolMinor == 8)) || ((twidentitylinux64safe.twidentity.ProtocolMajor == 1) && (twidentitylinux64safe.twidentity.ProtocolMinor == 9)) || ((twidentitylinux64safe.twidentity.ProtocolMajor == 1) && (twidentitylinux64safe.twidentity.ProtocolMinor == 91)) || ((twidentitylinux64safe.twidentity.ProtocolMajor == 2) && (twidentitylinux64safe.twidentity.ProtocolMinor == 0)) || ((twidentitylinux64safe.twidentity.ProtocolMajor == 2) && (twidentitylinux64safe.twidentity.ProtocolMinor == 1)) || ((twidentitylinux64safe.twidentity.ProtocolMajor == 2) && (twidentitylinux64safe.twidentity.ProtocolMinor == 2)) || ((twidentitylinux64safe.twidentity.ProtocolMajor == 2) && (twidentitylinux64safe.twidentity.ProtocolMinor == 3))))
    {
                           ...
                           TWID_T _DsId)
{
    ...
    if (AppValidateId(_pAppId) && m_ptwndsmappsimpl->m_AppInfo[(TWID_T)_pAppId->Id].pDSList && (_DsId < MAX_NUM_DS) && m_ptwndsmappsimpl->m_AppInfo[(TWID_T)_pAppId->Id].pDSList->DSInfo[_DsId].pHandle)
    {
        // Unload the library...
...
#if (TWNDSM_CMP == TWNDSM_CMP_VISUALCPP)
    BOOL boolResult;
    if (AppValidateId(_pAppId) && m_ptwndsmappsimpl->m_AppInfo[(TWID_T)_pAppId->Id].hwnd)
    {
